...
class LevelFiveController extends GetxController {
  ...
  void merge(
    ...
    if (mergeList.length < 7) {
      ...
      } else if (sportType == "sport13") {
        gameData[gameIndex].sport13?[sportIndex].isVisible = false;
      } else if (sportType == "sport14") {
        gameData[gameIndex].sport14?[sportIndex].isVisible = false;
      } else if (sportType == "sport15") {
        gameData[gameIndex].sport15?[sportIndex].isVisible = false;
      }
  ...
  void startGame() {
    ...
    gameData.value = [
      GameData(
        ...
        sport2: [
          SportModel(
              id: 13, name: "bolling ball", image: "assets/bolling_ball.webp"),
          SportModel(
        ...
        sport4: [
          SportModel(
              id: 15,
              name: "volleyball one",
              image: "assets/volleyball_one.webp"),
          SportModel(
              id: 7, name: "volleyball", image: "assets/volleyball.webp"),
        ...
        sport8: [
          SportModel(
              id: 14,
              name: "basketball one",
              image: "assets/basketball_one.webp"),
          SportModel(id: 8, name: "golf", image: "assets/golf.webp"),
