...
class LevelThreeController extends GetxController {
  ...
  void checkAndRemoveSports(SportModel sport) {
    ...
    if (clickCount.value == 30) {
      levelController.isLvlFourLock.value = false;
      LocalStorage.instance.write(StorageKey.isLvlFourLock.name, false);
