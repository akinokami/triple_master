...
import 'package:sport_sort/views/screens/game/level_four/box_four_widget.dart';
...
class LevelFourScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final levelFourController = Get.put(LevelFourController());
    return Scaffold(
        body: SafeArea(
      child: Container(
        ...
        child: Padding(
            ...
            child: Column(
              children: [
                ...
                Expanded(
                  child: Obx(
                    () => levelFourController.isLoading.value == true
                        ? const Center(
                            child: CustomLoading(),
                          )
                        : ListView.builder(
                            itemCount: levelFourController.gameData.length,
                  ...
                  () => Container(
                    ...
                    child: SizedBox(
                      ...
                      child: ListView.builder(
                          itemCount: levelFourController.mergeList.length,
                          ...
                          itemBuilder: (context, index) {
                            return Padding(
                              ...
                              child: Image.asset(
                                levelFourController.mergeList[index].image ??
                                    '',
                                width: 30.w,
                                height: 30.w,
                              ),
